...
<script type="text/javascript">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <form method="POST" action="{{action('Admin\tesouraria\TesourariaController@NovaSaida')}}" name="dados" onSubmit="return enviardados();">
                {!! csrf_field() !!}
                <div class="form-group">
                    ...
                    <input type="text" id="myCode" placeholder="Cod Plano Contas" onchange="setPlano()">  <select name="conta_id" id="mySelect" onchange="setCod()">
                        ...
                        <option value="{{$contadebito->Codigo}}">
                            {{$contadebito->Descricao}}                            
                        </option>
                        @endforeach                        
                    </select>
