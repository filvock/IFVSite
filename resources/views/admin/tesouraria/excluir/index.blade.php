...
<div class="box">
    ...
    <div class="box-body">
        <form method="POST" action="{{action('Admin\tesouraria\TesourariaController@CriarRelatorio')}}" name="dados" onSubmit="return enviardados();">
            {!! csrf_field() !!}
            <div class="form-group">
                <h4>Período dos lançamentos</h4>
                <h5>Início</h5>
