...
<div class="box">
    <div class="box-header">
        <h2>Relatório Livro Caixa e Banco</h2>
    </div>

    <div class="box-body">
        <form method="POST" action="{{action('Admin\relatorioslocais\RelatoriosLocaisController@GeraLivroCaixaBanco')}}" name="dados" onSubmit="return enviardados();">
            {!! csrf_field() !!}
