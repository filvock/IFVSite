...
class RelatoriosContasController extends Controller
{
    public $request;
    public $usuarios;
    public $tesouraria;
    ...
    {   
        ...
        return view('admin.relatorios.locais.contastotal.index', compact('user', 'uri', 'usuarios'));
    }
    ...
    public function GeraPaginaContasTotal(Request $request)
    {   
        $user = Auth()->User();
        $uri = ($this->request->route()->uri());
        $usuarios =$this->usuarios->all();
    ...
    public function GeraLivroContasTotal(Request $request)
    {   
        $user = Auth()->User();
        $uri = ($this->request->route()->uri());
        ...
        return view('admin.relatorios.locais.contastotal.relatorio', compact('user', 'uri', 'dadosRelatorio', 'totalEntradas','totalSaidas'));
    }
